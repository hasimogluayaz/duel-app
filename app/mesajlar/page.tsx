      ...
      <div className="hidden lg:flex h-[calc(100vh-4rem)] overflow-hidden">
        ...
        <div className="w-80 shrink-0 border-r border-stroke bg-surface flex flex-col overflow-hidden">
          ...
          <div className="px-4 py-4 border-b border-stroke shrink-0">
            ...
            {totalUnread > 0 && (
              <p className="text-[12px] text-fg-subtle mt-0.5">{totalUnread} okunmamış</p>
            )}
          </div>
          <ConversationList />
        </div>
        ...
        <div className="flex-1 flex flex-col items-center justify-center text-center bg-surface-2">
          <div className="w-16 h-16 rounded-2xl bg-surface flex items-center justify-center mb-4 border border-stroke">
            <MessageCircle size={28} className="text-fg-subtle opacity-40" />
          </div>
          <p className="text-fg font-semibold">Bir konuşma seç</p>
          <p className="text-fg-subtle text-sm mt-1">Soldan bir konuşma seçerek başla</p>
        </div>
      </div>
