    ...
    <div className="max-w-2xl mx-auto px-4 py-6 space-y-4">
      ...
      {isGuest && (
        <div className="flex items-center gap-3 bg-violet-600/10 border border-violet-500/20 rounded-2xl px-4 py-3">
          <p className="text-sm text-fg-muted flex-1">Emoji cevabı kaydetmek için <span className="font-semibold text-violet-500">ücretsiz katıl</span></p>
          <Link href="/kayit">
          ...
          {userAnswer ? (
            ...
            <div className="bg-surface border border-stroke rounded-2xl p-4 space-y-4">
              ...
              <input
                ...
                className="w-full bg-transparent border border-stroke rounded-xl px-4 py-2.5 text-2xl outline-none focus:border-purple-500/50 placeholder:text-fg-subtle placeholder:text-sm"
                disabled={!!submitting}
                inputMode="text"
              />
