      ...
      <div className="max-w-5xl mx-auto px-4 py-10">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
          <div className="col-span-2 md:col-span-1">
            ...
            <p className="text-sm text-fg-subtle">
              Günlük senaryolara cevap ver, arkadaşlarını düelloya çağır.
            </p>
          </div>

          <div>
            <h4 className="text-sm font-semibold text-fg-muted mb-3">Oyun</h4>
          ...
          <div>
            <h4 className="text-sm font-semibold text-fg-muted mb-3">Hesap</h4>
            <ul className="space-y-2">
              <li><Link href="/kayit" className="text-sm text-fg-subtle hover:text-fg transition-colors">Kayıt Ol</Link></li>
              <li><Link href="/giris" className="text-sm text-fg-subtle hover:text-fg transition-colors">Giriş Yap</Link></li>
              <li><Link href="/iletisim" className="text-sm text-fg-subtle hover:text-fg transition-colors">İletişim</Link></li>
            </ul>
          </div>

          <div>
            <h4 className="text-sm font-semibold text-fg-muted mb-3">Yasal</h4>
            <ul className="space-y-2">
              <li><Link href="/gizlilik" className="text-sm text-fg-subtle hover:text-fg transition-colors">Gizlilik</Link></li>
        ...
        <div className="mt-10 pt-6 border-t border-stroke flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-xs text-fg-subtle">
            © {new Date().getFullYear()} Kapisio. Tüm hakları saklıdır.
          </p>
          <p className="text-xs text-fg-subtle">
            Yapay zeka destekli ⚡ Türkiye
          </p>
        </div>
      </div>
    </footer>
