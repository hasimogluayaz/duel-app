    ...
    return (
      <div className="flex flex-col gap-1.5">
        ...
        <input
          ref={ref}
          className={cn(
            'w-full bg-bg border border-stroke rounded-xl px-4 py-2.5 text-fg placeholder:text-fg-subtle',
    ...
    return (
      <div className="flex flex-col gap-1.5">
        ...
        <textarea
          ref={ref}
          className={cn(
            'w-full bg-bg border border-stroke rounded-xl px-4 py-3 text-fg placeholder:text-fg-subtle resize-none',
            'focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent',
            'transition-all duration-150',
            error && 'border-red-500 focus:ring-red-500',
            className
